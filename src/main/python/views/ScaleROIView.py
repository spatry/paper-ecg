...
class XScaleROIItem(QtWidgets.QGraphicsRectItem):
    ...
    def itemChange(self, change, value):
        ...
        if change == QtWidgets.QGraphicsRectItem.ItemSelectedChange:
            self.parentViews[0].roiItemSelected.emit("X", value)
            if value == True:
                self.setZValue(1)
            else:
                self.setZValue(0)
    ...
    def paint(self, painter, option, widget=None):
        ...
        if self.isSelected():
            ...
            painter.drawText(self.rect(), QtCore.Qt.AlignCenter, "X")
            painter.drawRect(self.rect())

class YScaleROIItem(QtWidgets.QGraphicsRectItem):
    ...
    def paint(self, painter, option, widget=None):
        ...
        if self.isSelected():
            ...
            painter.setPen(QtGui.QPen(QtGui.QColor(128, 128, 128), 2.0, QtCore.Qt.SolidLine))
            painter.setBrush(QtGui.QBrush(QtGui.QColor(128, 128, 128, 64)))
            painter.drawText(self.rect(), QtCore.Qt.AlignCenter, "Y")
            painter.drawRect(self.rect())
